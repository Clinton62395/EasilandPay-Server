...
class WalletController {
  ...
  releaseEscrow = catchAsynch(async (req, res) => {
  ...
  withdraw = catchAsynch(async (req, res) => {
    const { amount } = req.body;
